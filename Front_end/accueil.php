            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Bienvenue sur votre plateforme iMangerMieux !</h1>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Le but de notre site ?</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Vous accompagner</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Sur quel domaine ?</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Votre alimentation !</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Profil complété à :
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Vous avez des questions ou des suggestions ?</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Contactez-nous !</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Avancée de notre site</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Ajout utilisateur <span
                                    ...
                                    <h4 class="small font-weight-bold">Page journal <span
                                            class="float-right">80%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Page repas <span
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark"> Pour nous contacter</h6>
                                </div>
                                <div class="card-body">
                                    <p> Pour nous contacter, vous pouvez nous envoyer un mail sur l'une des deux adresses mail suivantes :
                                        <ul>
                                            <li> <a>lea.grumiaux@etu.imt-nord-europe.fr</a>
                                            <li> <a>pierre.martin@etu.imt-nord-europe.fr</a>
                                        </ul>
                                    </p>
                                </div>
                            </div>
